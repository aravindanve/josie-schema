...
describe('check.isFormatString(value)', () => {
  it('must return `true` for valid type strings', () => {
    ...
    assert.strictEqual(check.isFormatString('idn-email'), true);
    assert.strictEqual(check.isFormatString('hostname'), true);
    assert.strictEqual(check.isFormatString('idn-hostname'), true);
    ...
    assert.strictEqual(check.isFormatString('iri'), true);
    assert.strictEqual(check.isFormatString('iri-reference'), true);
    assert.strictEqual(check.isFormatString('uri-template'), true);
    assert.strictEqual(check.isFormatString('json-pointer'), true);
    assert.strictEqual(check.isFormatString('relative-json-pointer'), true);
