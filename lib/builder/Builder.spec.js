...
describe('builder.hasType(...values)', () => {
  it('must return `true` if all specified types are set', () => {
    assert.strictEqual(Builder.type('string').hasType(), true);
    assert.strictEqual(Builder.type('string', 'number').hasType('string'), true);
    assert.strictEqual(Builder.type('string', 'number').hasType('number'), true);
    assert.strictEqual(Builder.type('string', 'number')
      .hasType('string', 'number'), true);
  });

  it('must return `false` if at least one specified type is not set', () => {
    assert.strictEqual(Builder.hasType(), false);
    assert.strictEqual(Builder.type('string').hasType('number'), false);
    assert.strictEqual(Builder.type('number').hasType('number', 'string'), false);
    assert.strictEqual(Builder.type('string', 'number')
      .hasType('string', 'number', 'null'), false);
  });
});
...
describe('Builder(properties)', () => {
  it('must alias `.object(properties)`', () => {
    assert.strictEqual(
